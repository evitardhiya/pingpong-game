...
class GameSprite(sprite.Sprite):
    def _init_(self, player_image, player_x, player_y, player_speed, wight, height):
        super()._init_()
        self.image = transform.scale(image.load(player_image), (wight, height))  # e.g. 55x55
...
racket1 = Player('ping-pong.png', 30, 200, 4, 50, 150)
racket2 = Player('ping-pong.png', 520, 200, 4, 50, 150)
ball = GameSprite('woman.png', 200, 200, 4, 50, 50)
